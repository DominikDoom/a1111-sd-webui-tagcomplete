TAC.main = (function TagAutocomplete() {
    const styleColors = {
    ...
    // Export our functions in case other extensions use them for interop
    return {
        addAutocompleteToArea: addAutocompleteToArea,
        autocomplete: autocomplete,
        navigateInList: navigateInList,
        refreshTacTempFiles: refreshTacTempFiles,
        refreshEmbeddings: refreshEmbeddings,
        updateRuby: updateRuby,
        isEnabled: isEnabled,
        isVisible: isVisible,
