...
def on_ui_settings():
    ...
    tac_options = {
        ...
        "tac_animaStyle.enabled": shared.OptionInfo(False, "Enable Anima style tag completion with '@'").info("Suggests type:1 (Artist) tags when '@' is typed. Uses data.js if specified below, otherwise falls back to CSV artist tags."),
        "tac_animaStyle.dataFile": shared.OptionInfo("None", "Anima-Style-Explorer data.js filename", gr.Dropdown, lambda: {"choices": js_files_withnone}, refresh=update_js_files).info("Download <a href=\"https://github.com/ThetaCursed/Anima-Style-Explorer/blob/main/app/data.js\" target=\"_blank\">data.js</a> from <a href=\"https://github.com/ThetaCursed/Anima-Style-Explorer\" target=\"_blank\">Anima-Style-Explorer</a> (MIT License, Copyright (c) 2026 ThetaCursed), place it in the tags folder, and select it here to enable '@' style tag completion.").needs_restart(),
